...
#define DefaultMP 0
#define DefaultAt 6
#define DefaultMs 0.8f
#define DefaultRg 0.2f
#define HoldTimes 1

#define animateFrame 0.05f


@implementation Enemy_Character06

- (id)initWithGameLayer:(GameLayer *)layer withLevel:(NSInteger)lv {
    if ((self = [super initWithSpriteFrameName:@"M_G_04_move_01.png"])) {
...
- (void)createCrashZone {
    CrashZoneNode *zone1 = [[CrashZoneNode alloc] initAsRectWithSize:CGSizeMake(26, 34)];
    ...
    CrashZoneNode *zone2 = [[CrashZoneNode alloc] initAsRectWithSize:CGSizeMake(33, 7)];
...
- (void)createWalkAnimate {
    ...
    for (int i=1; i<=19; i++) {
        CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"M_G_04_move_%02d.png", i]];
...
- (void)createAttackReadyAnimate {
    NSMutableArray *frames = [[NSMutableArray alloc] init];
    for (int i=1; i<=5; i++) {
        CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"M_G_04_atkR_%02d.png", i]];
        [frames addObject:frame];
    }
...
- (void)createAttackAnimate {
    NSMutableArray *frames = [[NSMutableArray alloc] init];
    for (int i=1; i<=3; i++) {
        CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"M_G_04_atk_%02d.png", i]];
        [frames addObject:frame];
    }
...
- (void)createAttackCompleteAnimate {
    NSMutableArray *frames = [[NSMutableArray alloc] init];
    for (int i=1; i<=6; i++) {
        CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"M_G_04_atkC_%02d.png", i]];
        [frames addObject:frame];
    }
...
- (void)createDieAnimate {
    NSMutableArray *frames = [[NSMutableArray alloc] init];
    for (int i=1; i<=12; i++) {
        CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"M_G_04_die_01.png"];
        [frames addObject:frame];
    }
...
- (void)createHitAnimate {
    NSMutableArray *frames = [[NSMutableArray alloc] init];
    for (int i=1; i<=7; i++) {
        CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"M_G_04_hit_%02d.png", i]];
        [frames addObject:frame];
    }
...
- (void)createHoldAnimate {
    NSMutableArray *frames = [[NSMutableArray alloc] init];
    for (int i=1; i<=10; i++) {
        CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"M_G_04_hold_%02d.png", i]];
        [frames addObject:frame];
    }
...
- (void)attackSchedule:(ccTime)dt {
    ...
    float moveDistance = (range/0.15f)*deltaTime;
...
- (void)attackCompleteSchedule:(ccTime)dt {
    ...
    float moveDistance = (range/0.3f)*deltaTime;
