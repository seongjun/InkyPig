...
@implementation UpgradeSkillLayerSprite

@synthesize icon1, icon2, icon3, icon4, icon5, icon6, icon7;
...
- (void)create {
    icon1 = [[CCSprite alloc] initWithSpriteFrameName:@"menu_upgrade_skill_01.png"];
    ...
    icon2 = [[CCSprite alloc] initWithSpriteFrameName:@"menu_upgrade_skill_02.png"];
    ...
    icon3 = [[CCSprite alloc] initWithSpriteFrameName:@"menu_upgrade_skill_03.png"];
    ...
    icon4 = [[CCSprite alloc] initWithSpriteFrameName:@"menu_upgrade_skill_04.png"];
    [icon4 setPosition:CGPointMake(icon2.position.x,
                                   icon3.position.y)];
    [self addChild:icon4];
    [icon4 release];
    
    icon5 = [[CCSprite alloc] initWithSpriteFrameName:@"menu_upgrade_skill_05.png"];
    ...
    icon6 = [[CCSprite alloc] initWithSpriteFrameName:@"menu_upgrade_skill_06.png"];
    [icon6 setPosition:CGPointMake(icon2.position.x,
                                   icon5.position.y)];
    [self addChild:icon6];
    [icon6 release];
    
    icon7 = [[CCSprite alloc] initWithSpriteFrameName:@"menu_upgrade_skill_07.png"];
...
- (void)show {
    ...
    /*
    for (int i=0; i<gameData.skillLevel.count; i++) {
        NSInteger currentLevel = [[[gameData skillLevel] objectAtIndex:i] integerValue];
