...
#define DefaultMP 0
#define DefaultAt 10
#define DefaultMs 1.4f
#define DefaultRg 6.3f
#define HoldTimes 1

#define animateFrame 0.05f


@implementation Enemy_Character05

- (id)initWithGameLayer:(GameLayer *)layer withLevel:(NSInteger)lv {
    if ((self = [super initWithSpriteFrameName:@"M_G_03_move_01.png"])) {
...
- (void)createCrashZone {
    CrashZoneNode *zone = [[CrashZoneNode alloc] initAsRectWithSize:CGSizeMake(50, 34)];
...
- (void)createWalkAnimate {
    ...
    for (int i=1; i<=13; i++) {
        CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"M_G_03_move_%02d.png", i]];
...
- (void)createAttackReadyAnimate {
    NSMutableArray *frames = [[NSMutableArray alloc] init];
    for (int i=1; i<=8; i++) {
        CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"M_G_03_atkR_%02d.png", i]];
        [frames addObject:frame];
    }
...
- (void)createAttackAnimate {
    NSMutableArray *frames = [[NSMutableArray alloc] init];
    for (int i=1; i<=4; i++) {
        CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"M_G_03_atk_%02d.png", i]];
        [frames addObject:frame];
    }
...
- (void)createAttackCompleteAnimate {
    NSMutableArray *frames = [[NSMutableArray alloc] init];
    for (int i=1; i<=8; i++) {
        CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"M_G_03_atkC_%02d.png", i]];
        [frames addObject:frame];
    }
...
- (void)createDieAnimate {
    NSMutableArray *frames = [[NSMutableArray alloc] init];
    for (int i=1; i<=12; i++) {
        CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"M_G_03_die_01.png"];
        [frames addObject:frame];
    }
...
- (void)createHitAnimate {
    NSMutableArray *frames = [[NSMutableArray alloc] init];
    for (int i=1; i<=7; i++) {
        CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"M_G_03_hit_%02d.png", i]];
        [frames addObject:frame];
    }
...
- (void)createHoldAnimate {
    NSMutableArray *frames = [[NSMutableArray alloc] init];
    for (int i=1; i<=10; i++) {
        CCSpriteFrame *frame = [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:[NSString stringWithFormat:@"M_G_03_hold_%02d.png", i]];
        [frames addObject:frame];
    }
